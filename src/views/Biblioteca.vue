      ...
      <v-col cols="12" class="px-4">
        <v-card elevation="1" color="#e9f3ff">
          <v-card-text>
            ...
            <b
              >El objetivo de éste módulo es la difusión de textos doctrinarios,
              permitiendo a todo el personal de la institución el acceso a los
              textos doctrinarios de acuerdo a su nivel de acceso a la
              información, base fundamental para el correcto desarrollo de las
              actividades propias de la función militar.</b
            >
          </v-card-text>
        </v-card>
      </v-col>
