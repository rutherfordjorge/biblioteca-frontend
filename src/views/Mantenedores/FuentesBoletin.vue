<template>
	<v-container fluid>
		<v-row dense>
			<v-col cols="12" class="text-center"><h1>Boletín Oficial</h1>
			</v-col>
      ...
      <v-col cols="12" class="px-4">
        <v-card elevation="1" color="#e9f3ff">
          <v-card-text>
            ...
            <b>En este módulo usted encontrará los Boletines Oficiales de la Institución
              que han sido publicados. Para tener acceso a estos Boletines
              de carácter reservado y/o secreto, se deberá solicitar por oficio, indicando nombre
              y RUN de la persona a la cual se le solicita
              otorgar acceso.</b>
              <br><br>
			...
			<template v-slot:default>
				<thead>
					<tr>
						...
						<th class="text-left" width="5%">Número</th>
						<th class="text-left" width="30%">Descripción</th>
						<th class="text-left" width="15%">Tipo</th>
						<th class="text-left" width="15%">Clasificación</th>
						<!-- <th class="text-left" width="30%">Correo</th> -->
						<th class="text-center" width="10%">Acciones</th>
					</tr>
				</thead>
				
				<draggable
					v-model="fuentesBoletin"
					tag="tbody"
