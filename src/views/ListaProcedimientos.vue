<template>
  <v-container>
    <v-card class="elevation-0">
      ...
      <v-container fluid>
        <v-data-table
          ...
          loading-text="Cargando...por favor esperad"
    ...
    <v-dialog v-model="dialogDelete" max-width="290">
      <eliminar-documento :key="editedItem.id" @closeDelete="closeDelete" :tipoArchivoId="41" :origenId="1" :item="editedItem"/>
    </v-dialog>
    <!-- Editar Doc -->
    <v-dialog v-model="dialog" max-width="1200px">
      <editar-documento :key="editedItem.id" @close="close" :tipoArchivoId="41" :origenId="1" :item="editedItem"/>
    </v-dialog>
    <!-- Guardar Doc -->
    <v-dialog v-model="dialogCargar" max-width="1200px">
      <guardar-documento :key="editedItem.id" @closeEdit="closeEdit" :tipoArchivoId="41" :origenId="1" :item="editedItem"/>
    </v-dialog>
  </v-container>
</template>
...
export default {
  ...
  data: () => ({
    ...
    Documentos: {
      items: [],
      headers: [
        { text: "Fecha", value: "fechA_DOC", width: "10%" },
        {
          text: "Numero",
          align: "left",
          sortable: true,
        ...
        { text: "Unidad", value: "unidad.sigla", width: "8%" },
        {
          text: "Clasificación",
          sortable: false,
          value: "clasificacion",
